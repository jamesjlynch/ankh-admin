...
function outputOrderPdf(array $order,string $type):never{
 ...
 $rowY-=38;$paidLike=in_array((string)$order['status'],['Paid','Packed','Dispatched','Delivered'],true);
 $statusText=$paidLike?'PAID / '.((string)$order['payment_method']?:'payment recorded'):'PAYMENT STATUS: '.strtoupper((string)$order['status']);
